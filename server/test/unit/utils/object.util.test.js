...
describe("Object Handler Tests", () => {
  ...
  describe("isObjectEmpty", () => {
    test("given object, check if it is not empty", () => {
      expect(Objects.isObjectEmpty({})).toBeTruthy();
    });

    test("given value, check if it is empty", () => {
      expect(Objects.isObjectEmpty({ a: 10 })).toBeFalsy();
    });
  });
  describe("isObjectNotEmpty", () => {
    test("given object, check if it is not empty", () => {
      expect(Objects.isObjectNotEmpty({})).toBeFalsy();
    });

    test("given value, check if it is empty", () => {
      expect(Objects.isObjectNotEmpty({ a: 10 })).toBeTruthy();
    });
  });
});
