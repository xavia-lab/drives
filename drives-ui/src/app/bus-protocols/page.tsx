...
export default function BusProtocolList() {
  ...
  return (
    <List>
      <Table {...tableProps} rowKey="id">
        ...
        />
        <Table.Column
          dataIndex="commandSet"
          title={"Command Set"}
          width={200}
          sorter={true}
          defaultSortOrder={getDefaultSortOrder("commandSet", sorters)}
          // Custom Filter Dropdown
          filterDropdown={(props) => (
            <FilterDropdown {...props}>
              <Input placeholder="Search by Command Set" />
            </FilterDropdown>
          )}
        />
        <Table.Column
          dataIndex="supportsHotPlug"
          title={"Supports Hotplug"}
          width={150}
          render={(value) =>
            value ? (
